(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppComponentsListasListasComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_deseos_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../services/deseos.service */
      "./src/app/services/deseos.service.ts");

      var ListasComponent = /*#__PURE__*/function () {
        function ListasComponent(deseosService, router, alert) {
        ...
        _createClass(ListasComponent, [{
          ...
          value: function listaSeleccionada(lista) {
            ...
            if (this.terminada) {
              this.router.navigateByUrl("/tabs/tab2/agregar/".concat(listaId));
            } else {
              this.router.navigateByUrl("/tabs/tab1/agregar/".concat(listaId));
            }
          }
        }, {
          key: "borrarLista",
          ...
          key: "updateLista",
          value: function updateLista(lista) {
            this.presentAlertPrompt(lista);
          }
        }, {
          key: "presentAlertPrompt",
          value: function presentAlertPrompt(lista) {
                      ...
                      return this.alert.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler(data) {
                            ...
                            _this.lista.closeSlidingItems(); //  this.deseosService.modificarLista(id, data.titulo);
    ...
    function srcAppModelsListaModelTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var Lista = function Lista(titulo) {
        ...
        this.titulo = titulo; // tslint:disable-next-line: new-parens
      ...
      var DeseosService = /*#__PURE__*/function () {
        ...
        _createClass(DeseosService, [{
          ...
          value: function obtenerLista(id) {
            id = Number(id);
            var found = this.listas.find(function (listaData) {
